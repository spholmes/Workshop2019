---
title: "Before coming to the ASM workshop"
abstract: 
    "ASM: Microbial Ecology using R and Bioconductor: From Raw Reads to Statistical Testing"
author: "Benjamin Callahan, Susan Holmes and Joey McMurdie"
...
We will mainly use two packages during this workshop: [dada2](https://benjjneb.github.io/dada2/index.html) and [phyloseq](https://joey711.github.io/phyloseq/index.html). 
...
## References
 ...
 - [Getting help in R](https://www.r-project.org/help.html)
 - [dada2 tutorial material](https://benjjneb.github.io/dada2/tutorial.html)
 - [Main phyloseq website](https://joey711.github.io/phyloseq/index.html)
 - [Workshop materials](http://web.stanford.edu/class/bios221/Workshops/)
 - [Github site for these materials](https://github.com/spholmes/Workshop2019)
